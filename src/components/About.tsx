...
export const About = () => {
  ...
  return <section id="about" className="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
    {/* Subtle animated background */}
    <div className="absolute inset-0 -z-10 opacity-30">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-orange-300/40 via-pink-300/30 to-transparent dark:from-orange-500/15 dark:via-pink-500/10 dark:to-transparent rounded-full blur-3xl animate-[pulse_20s_ease-in-out_infinite]" />
      <div className="absolute bottom-0 left-0 w-[450px] h-[450px] bg-gradient-to-tr from-blue-300/40 via-purple-300/30 to-transparent dark:from-blue-500/15 dark:via-purple-500/10 dark:to-transparent rounded-full blur-3xl animate-[float_25s_ease-in-out_infinite]" />
    </div>

    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100/80 dark:bg-indigo-900/30 backdrop-blur-sm rounded-full mb-4">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6 max-w-5xl mx-auto mb-8">
        <div className="group bg-gradient-to-br from-orange-50 to-pink-50 dark:from-orange-900/20 dark:to-pink-900/20 rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-all duration-300 border border-orange-200 dark:border-orange-800 transform hover:-translate-y-1">
          <div className="flex items-start gap-4">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-pink-600 rounded-xl blur-lg opacity-50 group-hover:opacity-75 transition-opacity"></div>
              <div className="relative p-3 bg-gradient-to-br from-orange-100 to-pink-100 dark:from-orange-900/40 dark:to-pink-900/40 rounded-xl">
                <GraduationCapIcon className="text-orange-600 dark:text-orange-400" size={24} />
              </div>
            </div>
            <div className="flex-1">
              ...
              <span className="inline-block px-3 py-1 bg-orange-200/50 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 rounded-full text-xs font-semibold">
                {siteConfig.status}
              </span>
            </div>
          </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto mb-10">
        <div className="group bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-700 transform hover:-translate-y-1">
          <div className="flex items-start gap-4">
            <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-xl group-hover:scale-110 transition-transform duration-300">
              <MailIcon className="text-orange-600 dark:text-orange-500" size={20} />
            </div>
